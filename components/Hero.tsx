    ...
    <section id="hero" className="relative flex min-h-[92vh] items-end overflow-hidden">
      ...
      <div className="container-x relative z-10 pb-16 pt-40 md:pb-24">
        ...
        <p className="mt-5 max-w-xl text-base text-cream/85 sm:text-lg">
          Прицепы-кэмперы (автодома на колёсах) от производителя — делаем в
          Республике Марий Эл и отправляем по всему Приволжскому федеральному
          округу и России. Превращаем дорогу в дом, а каждую остановку — в
          любимое место.
        </p>
