...
const SITE_DESCRIPTION =
  "VertadaCamp — завод-производитель кэмперов-прицепов в Йошкар-Оле (Республика Марий Эл). Продажа и доставка по ПФО и всей России напрямую, без посредников. Эконом, Базовая и Комфорт комплектации.";
